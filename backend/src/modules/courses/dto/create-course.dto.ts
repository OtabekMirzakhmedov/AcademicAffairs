...
export class CreateCourseDto {
  ...
  @ApiPropertyOptional({ example: 5, description: 'Teacher user ID to assign immediately' })
  @IsInt()
  @IsOptional()
  teacherId?: number;

  @ApiPropertyOptional({ example: 1, description: 'Academic period ID for assignment' })
  @IsInt()
  @IsOptional()
  academicPeriodId?: number;

  @ApiPropertyOptional({ example: ['CS-101', 'CS-102'], description: 'Group names for assignment' })
  @IsArray()
  @IsOptional()
  groups?: string[];
}
