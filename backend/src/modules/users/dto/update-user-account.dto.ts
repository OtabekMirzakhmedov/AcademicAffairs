...
export class UpdateUserAccountDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'Personal ID (14 digits)',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Tashkent State University',
    description: 'Bachelor degree university',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 2015,
    description: 'Bachelor graduation year',
  })
  @IsInt()
  @IsOptional()
  @Min(1900)
  ...
  @ApiPropertyOptional({
    ...
    description: 'Bachelor field of study',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'BS-12345',
    description: 'Bachelor diploma number',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Master degree university',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Master field of study',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'MS-67890',
    description: 'Master diploma number',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'PHD-11111',
    description: 'PhD diploma number',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Uzbekistan',
    description: 'Country where PhD was obtained',
  })
  @IsString()
  @IsOptional()
  phdCountry?: string;
  ...
  @ApiPropertyOptional({
    example: 'Academy of Sciences',
    description: 'PhD awarding organization',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Advanced AI Systems',
    description: 'DSc thesis topic',
  })
  @IsString()
  @IsOptional()
  dscTopic?: string;
  ...
  @ApiPropertyOptional({
    example: 'DSC-22222',
    description: 'DSc diploma number',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Uzbekistan',
    description: 'Country where DSc was obtained',
  })
  @IsString()
  @IsOptional()
  dscCountry?: string;
  ...
  @ApiPropertyOptional({
    example: 'Higher Attestation Commission',
    description: 'DSc awarding organization',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Academic title speciality',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 2022,
    description: 'Academic title award year',
  })
  @IsInt()
  @IsOptional()
  @Min(1900)
  ...
  @ApiPropertyOptional({
    example: 'AT-33333',
    description: 'Academic title attestat number',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Google 2019, Microsoft 2020',
  ...
  @ApiPropertyOptional({
    example: 5,
    description: 'Number of training courses completed',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 'AWS Certification, Docker Training',
  ...
  @ApiPropertyOptional({
    example: 'Best Research Paper 2021',
    description: 'Field-specific awards',
  })
  @IsString()
  @IsOptional()
  awardsField?: string;
  ...
  @ApiPropertyOptional({
    example: 'State Award for Science 2022',
    description: 'State-level awards',
  })
  @IsString()
  @IsOptional()
  awardsState?: string;
  ...
  @ApiPropertyOptional({
    example: 2,
    description: 'Number of DSc students supervised',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 10,
    description: 'National/republic conferences attended',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 5,
    description: 'International conferences attended',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 8,
    description: 'National/republic seminars attended',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 3,
    description: 'International seminars attended',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 2,
    description: 'Fundamental research projects',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 3,
    description: 'Practical/applied projects',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 2,
    description: 'Business collaboration projects',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 4,
    description: 'Number of innovative ideas submitted',
  })
  @IsInt()
  @IsOptional()
  @Min(0)
